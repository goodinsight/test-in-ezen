package kr.co.dong.checkPoint; //제출 - 거스름돈, 재고관리, 거스름돈 충전, 재고 충전

import java.util.Scanner;

public class Report_01_8 {
...
//					거스름돈 챙기기 -> 1천원1장 500원 100원 
			...
			case 90: // 관리자 모드 제품 잔량 확인 및 거스름돈 잔량 확인
				...
				System.out.printf("1. 재고 확인 \n");
				System.out.printf("2. 제품 잔량은 %s = %d개, %s = %d, %s = %d개 입니다. \n", drink1, count1, drink2, count2, drink3, count3);
				System.out.printf("3. 거스름돈 수량");
				totalMoney = sumMoney1 + sumMoney2 + sumMoney3;
				System.out.printf("((자판기 전체 금액 : %5d)) \n", totalMoney);
				System.out.printf("%d원 거스름돈 : %5d, %d장 남았습니다. \n", money3, sumMoney3, sumMoney3/1000 );
				System.out.printf(" %d원 거스름돈 : %5d, %d개 남았습니다. \n", money2, sumMoney2, sumMoney2/500 );
				System.out.printf(" %d원 거스름돈 : %5d, %d개 남았습니다. \n", money1, sumMoney1, sumMoney1/100 );
				System.out.println("변경사항이 있어면 아래 숫자를 눌러 주세요>");
				System.out.printf("4. 거스름돈 변경 %d :81, %d : 82, %d = 83 \n", money3, money2, money1);
				System.out.printf("5. 재고    변경 %d :91, %d : 92, %d = 93 시스템 종료 = 99\n", money3, money2, money1);
		
//				거스름돈 변경  + 재고 변경 switch
				inputMaster = scan.nextInt();
					switch (inputMaster) {
					case 81:
						System.out.printf("%d원 지폐를 넣어주세요.(단위:원) input:", money3);
						sumMoney3 = sumMoney3 + scan.nextInt();
						break;
					case 82:
						System.out.printf(" %d원 동전을 넣어주세요.(단위:원) input:", money2);
						sumMoney2 = sumMoney2 + scan.nextInt();
						break;
					case 83:
						System.out.printf(" %d원 동전을 넣어주세요.(단위:원) input:", money1);
						sumMoney1 = sumMoney1 + scan.nextInt();
						break;
						
					case 91:
						System.out.printf("%s 넣어주세요.(단위:개) input:", drink1);
						drink1 = drink1 + scan.nextInt();
						break;
					case 92:
						System.out.printf("%s 넣어주세요.(단위:개) input:", drink2);
						drink2 = drink2 + scan.nextInt();
						break;
					case 93:
						System.out.printf("%s 넣어주세요.(단위:개) input:", drink3);
						drink3 = drink3 + scan.nextInt();
						break;

					default:
						System.out.println(" 작동에 문제가 발생하였습니다. 초기화면으로 돌아갑니다.");
						break;
					} // end of 관리자 case
