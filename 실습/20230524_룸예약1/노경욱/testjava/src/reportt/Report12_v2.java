...
//		자판기 시작
		...
		while (!power) {
			...
			for (int i = 0; i < dName.length; i++) {
				System.out.print(dName[i] + "(재고:" + dAmount[i] + "개 1개:" + dPrice[i] + "원)" + " ");
			}
			System.out.println();
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("반환 완료 "+payy+"원");
				payy = 0;
				break;
			case 4:
				System.out.println("\n자판기를 종료합니다.");
			...
			case 77:
				while (!godd) {
					...
					case 1:
						...
						System.out.println(dName[tmp3 - 1] + "을 몇개 넣으시나요?");
						tmp4 = scan.nextInt();
						dAmount[tmp3 - 1] += tmp4;
						System.out.println(dName[tmp3 - 1] + "의 재고수: " + dAmount[tmp3 - 1]);
						break;
					case 2:
						System.out.println("현재 " + dName[0] + " " + dAmount[0] + "개");
						System.out.println("현재 " + dName[1] + " " + dAmount[1] + "개");
					...
					case 3:
						...
						System.out.println("1: " + dName[0] + " 2: " + dName[1] + " 3: " + dName[2]);
						tmp3 = scan.nextInt();
						System.out.println(dName[tmp3 - 1] + "의 가격을 얼마로 수정하시나요? 현재: " + dPrice[tmp3 - 1] + "원");
						tmp4 = scan.nextInt();
						dPrice[tmp3 - 1] = tmp4;
						System.out.println(dName[tmp3 - 1] + "의 가격은 " + dPrice[tmp3 - 1] + "원으로 수정하였습니다.");
						break;
					case 4:
