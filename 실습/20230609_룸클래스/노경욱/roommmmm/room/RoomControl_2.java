...
//		방 저장
	...
	private static void godmodd(List<Room> list) {
		...
		boolean power = true;
		while (power) {
			System.out.println("관리자모드 실행중");
			System.out.println("1. 호실확인 2. 호실추가 3. 호실삭제");
	...
	private static void removeRoom(List<Room> list) {
		System.out.println("선택한 방을 삭제합니다");

	}

	private static void addRoom(List<Room> list) {
		System.out.println("방을 추가합니다");
		System.out.println("양식: (101,\"소나무\",20000,\"1가\",예약상황(true,false))");
...
//	방넘버으로 방 찾기
	static int findRoomNumber(List<Room> list) {
		System.out.print("확인/선택할 호실을 입력해 주세요 (예시: 101)\n");
