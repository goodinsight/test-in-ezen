...
public class Report07_3 {
	...
	public static void main(String[] args) {
		...
		int[] coinType = { 100, 500, 1000, 5000, 10000, 50000 }; // 100원, 500원, 1000원, 5000원, 10000원, 50000원
		...
		while (!power) { // 자판기 루프 on
			...
			case 1: case 2: case 3: // 메뉴선택후 제품제공
				if (money >= dPrice[input-1]) {
					if (dAmount[input-1] >= 0) {
						System.out.println(dName[input-1] + " 나왔습니다.");
			...
			case 55: // 관리자모드 시작
				while (true) {
					...
					if (pass1.equals(pass2)) {
						...
						System.out.println("비밀번호가" + password_Count + "회 틀렸습니다.");
						password_Count++;
						if (password_Count > 3) {
			...
			case 99: // 자판기 종료
				...
				power = true;
				break; // 메뉴선택 끝
			case 100: case 500: case 1000: case 5000: case 10000: case 50000: // 금액 투입
				money += input; // 잔돈 누적
				for(int j=0; j<coinType.length;j++) { // 잔돈 개수 누적
					if(input == coinType[j]) {
						coin[j]++;
						break;
					}
