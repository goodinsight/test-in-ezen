...
/*				
				if(inCoin<sMoney[2]) { // 5000원 미만
					smAmount[3] = inCoin/sMoney[3];
					System.out.printf("잔돈은 %d원 화폐 + %d장 입니다. \n", sMoney[3], smAmount[3]);
				}
				else if(inCoin>=sMoney[2] && inCoin <sMoney[1]) { // 5000원 미만
					
					smAmount[2] = inCoin/sMoney[2];
					System.out.printf("잔돈은 %d원 화폐 + %d장 입니다. \n", sMoney[2], smAmount[2]);	
					inCoin = inCoin - smAmount[2]*sMoney[2];
					smAmount[3] = inCoin/sMoney[3];
					System.out.printf("잔돈은 %d원 화폐 + %d장 입니다. \n", sMoney[3], smAmount[3]);
				}
*/				
