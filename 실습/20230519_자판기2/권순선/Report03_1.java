							...
							while (num != 9) {
								...
								case 1: // 재고확인 및 변경
									...
									for (int i = 0; i < dAmount.length; i++) {
										System.out.println(dName[i] + " " + dAmount[i] + "개");
									}
											...
											System.out.println("1번 " + dAmount[0] + " 2번 " + dAmount[1] + " 3번 " + dAmount[2] + " 재고 변경");
								...
								case 3: // 가격변경
									...
									System.out.println("1번 " + dPrice[0] + " 2번 " + dPrice[1] + " 3번 " + dPrice[2] + " 가격 변경");
								...
								case 4: // 총매출 확인
									...
									System.out.println(dPrice[0] + " " + count + "개 판매");
									System.out.println(dPrice[1] + " " + count2 + "개 판매");
									System.out.println(dPrice[2] + " " + count3 + "개 판매");
									pay4 = pay + pay2 + pay3;
