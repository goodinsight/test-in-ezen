							...
							case 1: // 재고확인 및 변경
								...
								while (num != 44) {
									...
									case 1:
										...
										System.out.print("1번 재고 변경 >> ");
										dAmount[0] = sc.nextInt();
										dAmount[0] = dAmount[0];
										System.out.println();
										System.out.print("2번 재고 변경 >> ");
										dAmount[1] = sc.nextInt();
										dAmount[1] = dAmount[1];
										System.out.println();
										System.out.print("3번 재고 변경 >> ");
							...
							case 2: // 상품변경
								...
								while (num != 55) {
									...
									case 1:
										...
										System.out.print("1번 상품 변경 >> ");
										dName[0] = sc.next();
										dName[0] = dName[0];
										System.out.println();
										System.out.print("2번 상품 변경 >> ");
										dName[1] = sc.next();
										dName[1] = dName[1];
										System.out.println();
										System.out.print("3번 상품 변경 >> ");
										dName[2] = sc.next();
										dName[2] = dName[2];
							...
							case 3: // 가격변경
								...
								while (num != 66) {
									...
									case 1:
										...
										System.out.print("1번 가격 변경 >> ");
										dPrice[0] = sc.nextInt();
										dPrice[0] = dPrice[0];
										System.out.println();
										System.out.print("2번 가격 변경 >> ");
										dPrice[1] = sc.nextInt();
										dPrice[1] = dPrice[1];
										System.out.println();
										System.out.print("3번 가격 변경 >> ");
										dPrice[2] = sc.nextInt();
										dPrice[2] = dPrice[2];
