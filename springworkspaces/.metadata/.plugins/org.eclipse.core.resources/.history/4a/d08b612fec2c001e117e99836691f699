...
<body>
	...
	<form action="search/name" method="get">
		...
		영화 개봉일 <input type="text" name="m_opening"><br>
		영화 재개봉일 <input type="text" name="m_reopening"><br>
		...
		영화 장르 <input type="text" name="m_genre"><br>
		영화 관람연령 
		<select name="m_age">
		...
		<br> 
		영화 국가 <input type="text" name="m_nation"><br>
		<p></p>
